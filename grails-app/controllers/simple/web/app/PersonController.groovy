...
import com.myapp.rules.CreditScoreRule
...
class PersonController {
    ...
    def show(Person person) {
        updateCreditDecision(person)
        respond person
    }

    private void updateCreditDecision(Person person) {
        rule100.setCreditScore(person.creditScore)
        String decision = rule100.rule100()
